...
Kanji Grade Colorizer は、VS Code 上で小・中学校の学年別に漢字へ背景色を付けて表示できる拡張機能です。読みやすさの向上や学習支援を目的に、学年ごとに色を切り替えながら文章を確認できます。

## 主な特徴
- **学年ごとの色分け**：学年別漢字配当表に沿って g1〜g6、中学生（g7）、常用漢字外を判定し、背景色で区別します。
...
| `kanjiColorize.colors.g7` | 学年ごとの背景色 | 中学生: `#ff99cc` |
